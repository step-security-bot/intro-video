CREATE TABLE `instances` (
  ...
  `video4_id` integer,
  `video5_id` integer,
  `video1_strength` integer DEFAULT 1,
  `video2_strength` integer DEFAULT 1,
  `video3_strength` integer DEFAULT 1,
  `video4_strength` integer DEFAULT 1,
  `video5_strength` integer DEFAULT 1,
